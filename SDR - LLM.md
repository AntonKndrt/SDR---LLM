...
- Supabase остаётся единой backend-платформой: аутентификация, ДБ и Edge Functions.
- Выбранная модель поддерживает structured output или его эмуляцию через промпт.
